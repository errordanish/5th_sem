...
/******************** copy from traffic control (header files) ********************************************/
...
/***********type id se lekar tracing k upar tk comment krna hain********************************/
...
/**************flow copy krna hain traffic control se  destroy tk*******************************/

/*****************************socketType ko "ns3::UdpSocketFactory" and simulation time ko 10 krna hain*************************/

/****************nodes ki jagah c kiya hain aur interfaces ki jagah i kiya hain************************************************/
uint16_t port = 7;
...
/******************output only rx,tx,mean,jitter,throughput************************/
